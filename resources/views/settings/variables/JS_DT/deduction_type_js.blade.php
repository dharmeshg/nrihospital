...
var table_table = $('#deduction_type-table').DataTable({
    ...
    serverSide: true,
    ajax: {
        url: "{{ route('deduction_type.index') }}",
    },
    columns: [
        {
            data: 'type_name',
...
$('#deduction_type_submit').on('click', function (event) {
    ...
    $.ajax({
        url: "{{ route('deduction_type.store') }}",
        method: "POST",
...
$(document).on('click', '.deduction_type_edit', function () {
    ...
    var target = "{{ route('deduction_type.index') }}/" + id + '/edit';
    $.ajax({
        url: target,
        dataType: "json",
...
$('#deduction_type_edit_submit').on('click', function (event) {
    ...
    $.ajax({
        url: "{{ route('deduction_type.update') }}",
        method: "POST",
...
$(document).on('click', '.deduction_type_delete', function () {
    ...
    let target = "{{ route('deduction_type.index') }}/" + delete_id + '/delete';
