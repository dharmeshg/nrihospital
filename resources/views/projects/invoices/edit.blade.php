...
(function($) {
    ...
    $('#edit_invoice').on('submit', function (event) {
        ...
        $('.items-tax-total').val(total_tax.toFixed(2));
        $('#grand_total_form').val(grand_total.toFixed(2));
...
<script type="text/javascript" src="{{ asset('js/compiled_from_ts/invoice-edit.js') }}"></script>
@endpush
