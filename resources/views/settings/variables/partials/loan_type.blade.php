<div class="container-fluid">
    <div class="card mb-0">
        <div class="card-body">
            <h3 class="card-title">{{__('Add Loan Type')}}</h3>
            <form method="post" id="loan_type_form" class="form-horizontal" >
                @csrf
                <div class="input-group">
                    <input type="text" name="loan_type_name" class="form-control" placeholder="{{__('Loan Type')}}">
                    <input type="submit" id="loan_type_submit" class="btn btn-success" value={{trans("file.Save")}}>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form method="post" id="loan_type_form_edit" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="loan_type_edit_submit" id="loan_type_edit_submit" class="btn btn-success" value={{trans("file.Edit")}} />
                    </div>
                </form>
            </div>
        </div>
